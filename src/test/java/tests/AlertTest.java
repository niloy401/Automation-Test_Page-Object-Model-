...
public class AlertTest extends BaseTest {
    ...
    public void alertTest() {
        ...
        javaScriptAlertsPage.clickForJsConfirmBtn();
        getBrowser().handleAlert(AlertActions.ACCEPT);
        Assert.assertTrue(javaScriptAlertsPage.isConfirmLabelDisplayed(), "Confirm msg is not displayed");

        javaScriptAlertsPage.clickForJsPromptBtn();
        getBrowser().handlePromptAlert(AlertActions.ACCEPT, "Hi, I am Jarvis");
        Assert.assertTrue(javaScriptAlertsPage.isPromptLabelDisplayed(), "Prompt msg is not displayed");
    }
}
